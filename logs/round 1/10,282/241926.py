...
class OsmiumStrategy(Strategy):
    # ── Tune these ──────────────────────────────────────────────────────────
    MAX_PASSIVE_QTY   = 70     # How much liquidity to provide per tick. Higher = more profit potential, but more risk if swept.
    SKEW_DIVISOR      = 30     # Shift our prices 1 tick for every 15 units of inventory.
